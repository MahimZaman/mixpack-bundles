...
Create flexible mix-and-match product packs and bundles for WooCommerce.
...
* Selected-product or category-based bundles.
* Mix-and-match quantities.
* Live pack progress.
* Component stock validation.
* Bundle editing from the cart.
...
Yes. Pack quantities are configurable and are not limited to 3, 6, or 12.

= Can I use product categories instead of manually selecting products? =
...
* Added visual frontend bundle builder.
* Added live quantity and progress controls.
* Added cart editing.
* Added bundle validation and stock checks.
* Added order component handling.
* Added HPOS support.
* Added Cart and Checkout Blocks support.